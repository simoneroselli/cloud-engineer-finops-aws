SELECT 
  ...
  ROUND(
    SUM(
      CASE 
        WHEN resource_tags_user_environment IS NULL OR resource_tags_user_environment = '' 
          OR resource_tags_user_cost_center IS NULL OR resource_tags_user_cost_center = '' 
